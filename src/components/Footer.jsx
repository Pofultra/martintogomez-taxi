...
function Footer() {
  ...
  return (
    <>
      <Helmet>
        <title>Martingomez Taxi - Luxury Transportation Services</title>
        <meta
          name="description"
          content="Experience luxury transportation services with Martingomez Taxi. Book now for your next trip to Switzerland."
        />
        <meta
          name="keywords"
          content="luxury transport, switzerland, vip transport, private tours"
        />
        <meta name="author" content="Martingomez Taxi" />
      </Helmet>
